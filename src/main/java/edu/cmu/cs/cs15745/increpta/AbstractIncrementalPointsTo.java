 ...
 */
public class AbstractIncrementalPointsTo<Node, HeapItem> {

	private final AbstractPointsToGraph<Node, HeapItem> graph;
	...
	AbstractIncrementalPointsTo(AbstractPointsToGraph<Node, HeapItem> graph) {
		this.graph = graph;
	}
	 ...
	 */
	public class Graph implements IPointsToGraph<Node, HeapItem> {
